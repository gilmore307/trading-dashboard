...
ALLOWED_TABLES: tuple[DataTableSpec, ...] = (
    ...
    DataTableSpec(
        ...
        label="trading_data.m06_residual_event_governance_data_acquisition",
        schema="trading_data",
        table="m06_residual_event_governance_data_acquisition",
    ...
    DataTableSpec(
        ...
        label="trading_model.m05_option_expression_model_generation",
        schema="trading_model",
        table="m05_option_expression_model_generation",
    ...
    DataTableSpec(
        ...
        label="trading_data.m06_residual_event_governance_feature_generation",
        schema="trading_data",
        table="m06_residual_event_governance_feature_generation",
    ...
    DataTableSpec(
        ...
        label="trading_model.m06_residual_event_governance_model_generation",
        schema="trading_model",
        table="m06_residual_event_governance_model_generation",
