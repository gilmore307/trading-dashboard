...
- Models — ten layer model stack for current status, progress evidence, task detail, split status, receipts, blockers, and later performance/promotion posture.
