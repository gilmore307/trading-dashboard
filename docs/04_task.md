...
- First website slice is implemented: Vite + React + TypeScript renders a public read-only Tasks / Historical Modeling page from `historical_task_progress_summary_v1`, with clickable navigation, refresh, diagnostics expansion, and clickable summary/detail cards.
