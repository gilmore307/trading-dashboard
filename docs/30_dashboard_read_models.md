...
- Layers 4-10 do not render acceptance-threshold tables on the model-internals surface. Their model tab shows internal coefficients, feature importances, or scoring-contribution payloads when published; if no such payload exists, it shows publication pending instead of substituting thresholds;
