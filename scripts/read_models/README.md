...
- `read_latest_dashboard_read_model.py` reads one accepted `latest.json` file under `storage/06_dashboard_cache/read_models/<contract_type>/` and prints a UI-ready JSON view.
