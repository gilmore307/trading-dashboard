...
- `read_latest_dashboard_read_model.py` reads one accepted current file under `storage/06_dashboard_cache/read_models/<contract_type>.json` and prints a UI-ready JSON view.
